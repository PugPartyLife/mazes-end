...
import { BarChart3, Calendar, ChevronDown, TrendingDown } from 'lucide-react';
...
// Tournament results bar chart component
...
const TournamentPercentageChart = ({ 
  ...
  // Sort based on percentages if sorting by wins/draws/losses
...
// Main Tournament Stats Panel Component
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">
            Tournament <span className="text-yellow-400 font-serif">Statistics</span>
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Track your tournament performance across different time periods
          </p>
        </div>
